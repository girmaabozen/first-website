...
First we must ___? Next we can execute (or two other words for executing a function?) a function by?
...
// ------------------------- Functions:
// first we must create a function with the key word "function" followed by the
// the name of the function followed by the parentheesis & curly braces
//..... function dogs (paramater){code block}


    //your inputs parameters are ur place houlders 
    // you must invoke (call) functions by their name dogs();
